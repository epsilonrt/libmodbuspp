...
macro(GetDate)
  ...
  if (${GD_PREFIX}MONTH EQUAL 1)
    set (${GD_PREFIX}MONTH_STR "January")
  elseif (${GD_PREFIX}MONTH EQUAL 2)
    set (${GD_PREFIX}MONTH_STR "February")
  elseif (${GD_PREFIX}MONTH EQUAL 3)
    set (${GD_PREFIX}MONTH_STR "March")
  elseif (${GD_PREFIX}MONTH EQUAL 4)
    set (${GD_PREFIX}MONTH_STR "April")
  elseif (${GD_PREFIX}MONTH EQUAL 5)
    set (${GD_PREFIX}MONTH_STR "May")
  elseif (${GD_PREFIX}MONTH EQUAL 6)
    set (${GD_PREFIX}MONTH_STR "June")
  elseif (${GD_PREFIX}MONTH EQUAL 7)
    set (${GD_PREFIX}MONTH_STR "July")
  elseif (${GD_PREFIX}MONTH EQUAL 8)
    set (${GD_PREFIX}MONTH_STR "August")
  elseif (${GD_PREFIX}MONTH EQUAL 9)
    set (${GD_PREFIX}MONTH_STR "September")
  elseif (${GD_PREFIX}MONTH EQUAL 10)
    set (${GD_PREFIX}MONTH_STR "October")
  elseif (${GD_PREFIX}MONTH EQUAL 11)
    set (${GD_PREFIX}MONTH_STR "November")
  elseif (${GD_PREFIX}MONTH EQUAL 12)
    set (${GD_PREFIX}MONTH_STR "December")
  endif ()
  ...
  if(${GD_PREFIX}VERBOSE)
    ...
    message(STATUS "${GD_PREFIX}MONTH_STR='${${GD_PREFIX}MONTH_STR}'")
