...
ObjectsFileList        :="read-coils.txt"
PCHCompileFlags        :=
...
CXX      := /usr/bin/g++
CC       := /usr/bin/gcc
CXXFLAGS := $(shell pkg-config --cflags libmodbuspp) -g -O0 -Wall $(Preprocessors)
...
$(IntermediateDirectory)/main.cpp$(ObjectSuffix): main.cpp $(IntermediateDirectory)/main.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/pascal/src/libmodbuspp/examples/master/read-coils/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IncludePath)
