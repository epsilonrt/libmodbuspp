/**
  @brief MODBUS TCP gateway to serial port (RTU) with call back functions
...
int beforeReplyCB (const Request & req, Device * dev);
int afterReplyCB (const Request & req, Device * dev);
...
int beforeReplyCB (const Request & req, Device * dev) {
  cout << "beforeReplyCB --- " << req.slave() << " > " << req << " < "
       << req.slave() << " ---" << endl;
  return 0;
}
...
int afterReplyCB (const Request & req, Device * dev) {
  cout << "afterReplyCB  --- " << req.slave() << " > " << req << " < "
       << req.slave() << " ---" << endl;
  return 0;
}
/* ========================================================================== */
